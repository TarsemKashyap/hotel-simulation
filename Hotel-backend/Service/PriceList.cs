...
public class PriceListCreated
{
    ...
    public List<PriceDecisionPriceList> PriceDecisionPriceList()
    {
        ...
        {
        new PriceDecisionPriceList { DistributionChannel = "Direct",               WeekDay=true, Segment = "Business", Price = 200, ActualDemand = 0 },
         new PriceDecisionPriceList { DistributionChannel = "Direct",              WeekDay=true,Segment = "Small Business", Price = 150, ActualDemand = 0},
            new PriceDecisionPriceList { DistributionChannel = "Direct",           WeekDay=true, Segment = "Corporate contract", Price = 160, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",               WeekDay=true, Segment = "Families", Price = 125, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",               WeekDay=true, Segment = "Afluent Mature Travelers", Price = 165, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Direct",               WeekDay=true, Segment = "Corporate/Business Meetings", Price = 200, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",               WeekDay=true, Segment = "Association Meetings", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",         WeekDay=true, Segment = "Business", Price = 200, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",         WeekDay=true, Segment = "Small Business", Price = 150, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",         WeekDay=true, Segment = "Families", Price = 125, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",         WeekDay=true, Segment = "Afluent Mature Travelers", Price = 165, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",         WeekDay=true, Segment = "Corporate/Business Meetings", Price = 200, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",         WeekDay=true, Segment = "Association Meetings", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",  WeekDay=true, Segment = "Business", Price = 200, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",  WeekDay=true, Segment = "Small Business", Price = 150, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",  WeekDay=true, Segment = "Families", Price = 125, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",  WeekDay=true, Segment = "Afluent Mature Travelers", Price = 165, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",  WeekDay=true, Segment = "Corporate/Business Meetings", Price = 200, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",  WeekDay=true, Segment = "Association Meetings", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",               WeekDay=true, Segment = "Business", Price = 200, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",               WeekDay=true, Segment = "Small Business", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",               WeekDay=true, Segment = "Corporate contract", Price = 160, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",               WeekDay=true, Segment = "Families", Price = 125, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",               WeekDay=true, Segment = "Afluent Mature Travelers", Price = 165, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Opaque",               WeekDay=true, Segment = "Corporate/Business Meetings", Price = 200, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",               WeekDay=true, Segment = "Association Meetings", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",                WeekDay=false,Segment = "Business", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",                WeekDay=false,Segment = "Small Business", Price = 125, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",                WeekDay=false,Segment = "Corporate contract", Price = 160, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",                WeekDay=false,Segment = "Families", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",                WeekDay=false,Segment = "Afluent Mature Travelers", Price = 200, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Direct",                WeekDay=false,Segment = "Corporate/Business Meetings", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Direct",                WeekDay=false,Segment = "Association Meetings", Price = 175, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",          WeekDay=false,Segment = "Business", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",          WeekDay=false,Segment = "Small Business", Price = 125, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",          WeekDay=false,Segment = "Families", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",          WeekDay=false,Segment = "Afluent Mature Travelers", Price = 200, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",          WeekDay=false,Segment = "Corporate/Business Meetings", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Travel Agent",          WeekDay=false,Segment = "Association Meetings", Price = 175, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",   WeekDay=false,Segment = "Business", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",   WeekDay=false,Segment = "Small Business", Price = 125, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",   WeekDay=false,Segment = "Families", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",   WeekDay=false,Segment = "Afluent Mature Travelers", Price = 200, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",   WeekDay=false,Segment = "Corporate/Business Meetings", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Online Travel Agent",   WeekDay=false,Segment = "Association Meetings", Price = 175, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",                WeekDay=false,Segment = "Business", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",                WeekDay=false,Segment = "Small Business", Price = 125, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",                WeekDay=false,Segment = "Corporate contract", Price = 160, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",                WeekDay=false,Segment = "Families", Price = 150, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",                WeekDay=false,Segment = "Afluent Mature Travelers", Price = 200, ActualDemand = 0},
        ...
        new PriceDecisionPriceList { DistributionChannel = "Opaque",                WeekDay=false,Segment = "Corporate/Business Meetings", Price = 165, ActualDemand = 0},
        new PriceDecisionPriceList { DistributionChannel = "Opaque",                WeekDay=false,Segment = "Association Meetings", Price = 175, ActualDemand = 0}
