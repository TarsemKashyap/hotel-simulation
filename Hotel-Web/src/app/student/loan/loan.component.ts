...
export class LoanComponent implements OnInit {
  ...
  private createForm(): FormGroup {
    return this.fb.group({
      payLongTermLoan: ['', [Validators.required, DecimalValidator, this.payLongCustomValidator()]],
      payEmergencyLoan: ['', [Validators.required, DecimalValidator, this.payEmergencyCustomValidator()]],
  ...
  onSubmit(): void {
    ...
    this.balanceSheetDetails.longDebtPay = parseFloat(this.form.value.payLongTermLoan);
