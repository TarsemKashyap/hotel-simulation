...
export class QualityRatingComponent {
  ...
  qualityRatingReportResponse : QualityRatingReportResponse = {} as QualityRatingReportResponse;
  public chart: any;
  ...
  loadReportDetails() {    
    ...
    this.reportService.qualityRatingReportDetails(this.reportParam).subscribe((reportData) => {
      // console.log('DATA...........');
     ...
     //this.YaxisData.push.apply(this.YaxisData,this.ChartData);
          this.YaxisHotel.push.apply(this.YaxisHotel,this.ChartData.map(i=>i.hotel));
     this.YaxisMarketAvg.push.apply(this.YaxisMarketAvg,this.ChartData.map(i=>i.marketAverage));
