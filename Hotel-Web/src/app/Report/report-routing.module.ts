...
export const reportRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: ':id/market-share-revenue-report',
        component: MarketShareRevenueComponent,
      },
      {
        path: ':id/market-share-roomsold-report',
        component: MarketShareRoomSoldComponent,
      },
      {
        path: ':id/market-share-position-alone-report',
        component: MarketSharePositionAloneComponent,
      },
      {
        path: ':id/attribute-amentities-report',
        component: AttributeAmentitiesComponent,
      },
      {
        path: ':id/market-expenditure-report',
        component: MarketExpenditureComponent,
      },
      { path: ':id/position-map-report', component: PositionMapComponent },
      { path: ':id/quality-rating-report', component: QualityRatingComponent },
      {
        path: ':id/inst-performance-report',
        component: PerformanceInstComponent,
      },
      {
